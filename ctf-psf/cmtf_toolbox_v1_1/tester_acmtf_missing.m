...
%% Parse inputs
params = inputParser;
params.addParamValue('R', 4, @(x) x > 0);
params.addParamValue('size', [50 30 20 100], @isnumeric);
...
params.addParamValue('lambdas', {[0.5 0.5 0.5 0.5], [0.5 0.5 0.5 0.5]}, @iscell);
params.addParamValue('M',[0.8 0], @isnumeric);
