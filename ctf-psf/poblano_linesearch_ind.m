function [xk,x,f,g,a,lsinfo,lsnfev] = poblano_linesearch_ind(FUN,xk,x0,f0,g0,a0,d0,index,params)
...
[xk,x,f,g,a,lsinfo,lsnfev] = feval(minfun,FUN,xk,x0,f0,g0,a0,d0,index,params);
